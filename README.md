...
training, so a bad one is a line in a table rather than something you notice weeks
later while walking through it:
...
that, and `just quality --renders` prints their paths. Low SSIM beside a fair PSNR
