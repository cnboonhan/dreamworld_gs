...
Prefect deployment. One job runs at a time — the stages want every card
they are given to themselves, main's own concurrency limit — and
submissions made meanwhile wait in a FIFO the worker drains:
