...
async function main() {
    ...
    if (carousel) {
        try {
            ...
            if (camRes.ok) {
                ...
                if (Array.isArray(cam.viewMatrix) && cam.viewMatrix.length === 16) {
    ...
    // The tour, from <name>.paths.json: one walk per corridor leaving this
    // waypoint. A world generated at a waypoint has no single walk, and riding
